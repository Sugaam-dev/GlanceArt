...
// //                  <a href="/contemporary" className="collection-item"><img src="/assets/images/gallary4.webp" alt="Landscape" /><span>Contemporary</span></a>
// //                 <a href="/folk-art" className="collection-item"><img src="/assets/images/gallary3.webp" alt="Photography" /><span>Folk Art</span></a>
// //               </div>
// //             </NavDropdown>
          ...
          <Nav className="navbar-items">
            ...
            <NavDropdown title="COLLECTIONS" id="coll-drop" className="nav-item-custom dropdown-custom collections-dropdown">
              <div className="collection-grid">
                ...
                <a href="/landscape" className="collection-item"><img src="/assets/images/gallary4.webp" alt="Landscape" /><span>Landscape</span></a>
                <a href="/geometric" className="collection-item"><img src="/assets/images/gallary5.webp" alt="Geometric" /><span>Geometric</span></a>
                <a href="/contemporary" className="collection-item"><img src="/assets/images/gallary4.webp" alt="Landscape" /><span>Contemparary</span></a>
                <a href="/folk-art" className="collection-item"><img src="/assets/images/gallary5.webp" alt="Geometric" /><span>Folk Art</span></a>
              </div>
            </NavDropdown>
